 ...
 *
 */
public class DownloadJobMainPanel extends JPanel implements AddAdvancedFilterInterface {
	...
	private DefaultListModel mAdvancedFilterListModel = null;
	...
	private void initialize() {
		this.setSize(402, 621);
		
		jLabelAdvancedFilter = new JLabel();
		jLabelAdvancedFilter.setBounds(new Rectangle(20, 390, 341, 31));
		...
		jLabelBaseURL.setBounds(new Rectangle(20, 570, 341, 21));
	...
	private JCheckBox getJFollowOnlyRelativeLinks() {
		if (jFollowOnlyRelativeLinks == null) {
			...
			jFollowOnlyRelativeLinks.setBounds(new Rectangle(20, 550, 251, 21));
	...
	private JTextField getJBaseURL() {
		if (jBaseURL == null) {
			...
			jBaseURL.setBounds(new Rectangle(20, 590, 361, 21));
	...
	private JButton getJAddFileFilterButton() {
		if (jAddFileFilterButton == null) {
			...
			jAddFileFilterButton.setBounds(new Rectangle(180, 320, 71, 21));
			jAddFileFilterButton.setActionCommand("Add");
			jAddFileFilterButton.setText("<--");
	...
	private JButton getJRemoveFileFilterButton() {
		if (jRemoveFileFilterButton == null) {
			...
			jRemoveFileFilterButton.setBounds(new Rectangle(180, 350, 71, 21));
			jRemoveFileFilterButton.setActionCommand("Remove");
			jRemoveFileFilterButton.setText("-->");
	...
	private JButton getJAddHostnameFilterButton() {
		if (jAddHostnameFilterButton == null) {
			...
			jAddHostnameFilterButton.setBounds(new Rectangle(180, 220, 71, 21));
			jAddHostnameFilterButton.setText("<--");
	...
	private JButton getJRemoveHostnameFilterButton() {
		if (jRemoveHostnameFilterButton == null) {
			...
			jRemoveHostnameFilterButton.setBounds(new Rectangle(180, 260, 71, 21));
			jRemoveHostnameFilterButton.setText("-->");
	 ...
	 */
	private DefaultListModel getAdvancedFilterListModel() {
		if (mAdvancedFilterListModel == null) {
			mAdvancedFilterListModel = new DefaultListModel();
		}
	...
	private JButton getJButtonAdvancedFilterAdd() {
		if (jButtonAdvancedFilterAdd == null) {
			...
			jButtonAdvancedFilterAdd.setBounds(new Rectangle(50, 510, 91, 21));
			...
			jButtonAdvancedFilterAdd.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					new AddAdvancedFilterDialog(mParentDialog, DownloadJobMainPanel.this);
				}
			});
		}
	...
	private JButton getJButtonAdvancedFilterRemove() {
		if (jButtonAdvancedFilterRemove == null) {
			...
			jButtonAdvancedFilterRemove.setBounds(new Rectangle(230, 510, 91, 21));
	...
	private JScrollPane getJAdvancedFilterListScrollPane() {
		if (jAdvancedFilterListScrollPane == null) {
			...
			jAdvancedFilterListScrollPane.setBounds(new Rectangle(20, 420, 361, 81));
	...
	private JScrollPane getJFileFilterListScrollPane() {
		if (jFileFilterListScrollPane == null) {
			...
			jFileFilterListScrollPane.setBounds(new Rectangle(20, 310, 151, 71));
	...
	private JScrollPane getJHostnameFilterListScrollPane() {
		if (jHostnameFilterListScrollPane == null) {
			...
			jHostnameFilterListScrollPane.setBounds(new Rectangle(20, 210, 151, 71));
